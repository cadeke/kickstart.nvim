...
keymap('v', '<A-k>', ":m '<-2<CR>gv=gv", { desc = 'Move selected lines up (Alt+k)', noremap = true, silent = true })
keymap('v', '<A-j>', ":m '>+1<CR>gv=gv", { desc = 'Move selected lines down (Alt+j)', noremap = true, silent = true })
keymap('v', 'j', 'gj', { noremap = true, silent = true })
keymap('v', 'k', 'gk', { noremap = true, silent = true })
...
-- go back to last cursor position when reopening a file
...

      {
        ...
        opts = {
          progress = {
            ...
            ignore = { 'ltex' }, -- Ignore ltex progress notifications
          },
        },
      },
